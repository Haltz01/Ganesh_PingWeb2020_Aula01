...
### Conceitos iniciais:
- [Arquitetura de uma aplicação Web (e a diferença entre Internet e Web)](https://github.com/Haltz01/Ganesh_PingWeb2020_Aula01/blob/master/Arquitetura_web.md)

### Estrutura do front-end de uma página Web:
- [Introdução ao HTML](https://github.com/Haltz01/Ganesh_PingWeb2020_Aula01/blob/master/HTML.md)
- [Introdução ao CSS](https://github.com/Haltz01/Ganesh_PingWeb2020_Aula01/blob/master/CSS.md)
